...
class GraphComponent extends Component {
	...
	{
	    try {
		$this->FacebookRequest = new FacebookRequest($this->FacebookSession, 'GET', '/me?fields=name,email,id,first_name,last_name');
...
//	    $this->_configs['user_columns']['last_name'] => $this->FacebookLastName,
	...
	if ($result = $this->Users->save($user))
	{
	    $this->__autoLogin($result);
            ...
            $this->Flash->error(__('The user could not be saved. Please, try again later.'));
        }
    }
